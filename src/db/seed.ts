...
const EXERCISES = [
  ...
  { name: 'Sissy Squat',                  type: 'reps'     as const, category: 'legs'        as const },
  { name: 'Spanish Squat',               type: 'reps'     as const, category: 'legs'        as const },
  { name: 'Walking Lunges',              type: 'reps'     as const, category: 'legs'        as const },
