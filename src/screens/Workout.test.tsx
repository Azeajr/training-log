...
it('persists effective main-lift load and the exact band setup across raw-load edits', async () => {
  ...
  // 191 raw − 48 assistance = 143, the measured load, not 145 off a 5lb grid.
  expect((await db.sets.toArray())[0]).toMatchObject({ weight: 143, bandLoad: { band: 'Green', rawLoad: 191, assistance: 48, addedWeight: 0 } })
  ...
  expect((await db.sets.toArray())[0]).toMatchObject({ weight: 143, bandLoad: { rawLoad: 191 } })
